 ...
 * And a wallet's status for COS: 6.11+.
 ...
 * ConfirmationMode.dynamic: Wallet's public key, wallet's status (COS 6.11+), `challenge`, and `publicKeySalt`,
 ...
 * @property walletStatus   Status of the wallet. COS v.6.11+
