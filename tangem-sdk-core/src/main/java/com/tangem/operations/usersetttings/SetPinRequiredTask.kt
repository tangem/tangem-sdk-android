...
class SetPinRequiredTask(private val isRequired: Boolean) : CardSessionRunnable<SuccessResponse> {
    ...
    override fun run(session: CardSession, callback: CompletionCallback<SuccessResponse>) {
        ...
        val userSettings = card.userSettings.copy(isPINRequired = isRequired)
    ...
    protected fun finalize() {
        Log.debug { "SetPinRequiredTask finalize" }
    }
}