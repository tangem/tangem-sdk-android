...
class BIP39Wordlist : Wordlist {

    override val words: List<String> by lazy(LazyThreadSafetyMode.NONE, ::getDictionary)

    init {
        validateDictionarySize(words)
    }
    ...
    private companion object {
        ...
        const val DICTIONARY_SIZE = 2048

        @Suppress("LongMethod")
        fun getDictionary(): List<String> = listOf(
