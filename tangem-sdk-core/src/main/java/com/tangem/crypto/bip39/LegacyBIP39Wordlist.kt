...
@Deprecated(
    message = "This class is deprecated and will be removed in future versions. Use BIP39Wordlist instead.",
    replaceWith = ReplaceWith("BIP39Wordlist"),
)
class LegacyBIP39Wordlist(wordlistStream: InputStream) : Wordlist {
